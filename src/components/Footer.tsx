  ...
  return (
    <footer className="bg-dostyq-header-footer px-8 py-16">
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10 justify-items-center text-center">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-dostyq-text text-base mb-6 leading-relaxed max-w-md">
            ...
            <ul className="space-y-4 w-full">
              <li>
                <a
                  ...
                  className="text-dostyq-text hover:text-dostyq-menu-inactive transition-colors flex items-center justify-center gap-3"
                >
                  <span>📷</span> Instagram
                </a>
              </li>
